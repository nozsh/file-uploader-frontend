...
})({"lbcRN":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "730bfec3513aed0e";
"use strict";
...
if ("serviceWorker" in navigator) window.addEventListener("load", ()=>{
    navigator.serviceWorker.register(swsw, {
        scope: "/"
    }).then((registration)=>{
...
fileInput.addEventListener("change", ()=>{
    if (fileInput.files && fileInput.files.length > 0) uploadWarn();
});
if (dropzone && fileInput) {
    ...
    dropzone.addEventListener("drop", (event)=>{
        ...
        if (event.dataTransfer) {
            ...
            if (files.length > 0) uploadWarn();
        }
    });
}
if (document.getElementById("login_modal_btn")) {
    const modal_warn = document.getElementById("modal_warn");
...
if (document.getElementById("registration_btn")) document.getElementById("registration_btn")?.addEventListener("click", ()=>{
...
},{"./login":"iL357"}],"iL357":[function(require,module,exports,__globalThis) {
"use strict";
const login_btn = document.getElementById("login_btn");
const login_status_btn = document.getElementById("login_status_btn");
...
login_btn.addEventListener("click", ()=>{
    ...
    fetch("/login").then((response)=>{
        if (!response.ok) error_message.style.display = "block";
    }).catch((error)=>{
...
const checkUsernamePasswordInput = ()=>{
...
},{}]},["lbcRN","3uyIQ"], "3uyIQ", "parcelRequire94c2")
